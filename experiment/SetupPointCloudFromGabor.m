...
if (options.measure)
    ...
    if (ispref('SACC_Modeling','SCMDData'))
        testFiledir = getpref('SACC_Modeling','SCMDData');
        testFilename = fullfile(testFiledir,'TestImages_forIsetBio','targetScreenSpdMeasured.mat');
    end
